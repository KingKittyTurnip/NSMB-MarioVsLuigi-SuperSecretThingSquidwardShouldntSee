...
public class BackgroundLoop : MonoBehaviour {
    ...
    public void Reposition() {
        for (int i = 0; i < children.Length; i++) {
            ...
            //float differenceY = transform.position.y - lastPosition.y + (obj.transform.position.y - positionsAfterPixelSnap[i].y);
            ...
            //truePositions[i] += differenceY * parallaxSpeed * Vector3.up;
