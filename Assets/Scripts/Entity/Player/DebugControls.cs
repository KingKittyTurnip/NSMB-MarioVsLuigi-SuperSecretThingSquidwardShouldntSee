...
public class DebugControls : MonoBehaviour {
    ...
    public void Update() {
        ...
        DebugItem(Key.Numpad9, "Glock");
        DebugItem(Key.NumpadPeriod, "PoisonMushroom");
        DebugItem(Key.NumpadPlus, "Strawberry");
        DebugItem(Key.NumpadMinus, "PortalGun");
