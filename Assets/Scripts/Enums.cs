...
public static class Enums {
    ...
    public static readonly Dictionary<PowerupState, PriorityPair> PowerupStatePriority = new() {
        ...
        [PowerupState.Glock] = new(2),
        [PowerupState.MegaMushroom] = new(4),
        [PowerupState.Sword] = new(2),
        [PowerupState.Bat] = new(2),
        [PowerupState.Strawberry] = new(2),
        [PowerupState.PortalGun] = new(2),
        [PowerupState.Goggles] = new(2),
        [PowerupState.Glockos] = new(2),
    };
    public enum PowerupState : byte {
        None, MiniMushroom, Small, Mushroom, FireFlower, IceFlower, PropellerMushroom, MegaMushroom, Glock, Sword, Bat, Strawberry, PortalGun, Goggles, Glockos
    }
    #endregion
    #region ANIMATION & MUSIC
    // Animation enums
    public enum PlayerEyeState {
        Normal, HalfBlink, FullBlink, Death, Angry, AngryHalfBlink, AngryFullBlink
    }
    // Music Enums
    ...
    public enum Sounds : byte {
        ...
        //hey Ipod, this isn't the best way to do this yknow. 
        //CURRENT MAX: 127
        ...
        [SoundData("player/DamageHealth")]                      Player_Sound_DamageHealth = 126, //sound taken straight from HCM. 
        ...
        [SoundData("player/walk/metal")]                        Player_Walk_Metal = 127,
        ...
        [SoundData("character/{char}/course_in")]               Player_Sound_Course_In = 120,
        [SoundData("character/{char}/lava_burnt")]              Player_Sound_LavaBurnt = 125,
        ...
        [SoundData("powerup/glock/glock_shoot")]                Powerup_Glock_Shoot = 95,
        [SoundData("powerup/glock/glock_empty")]                Powerup_Glock_Fail = 96,
        [SoundData("powerup/glock/glock_reload")]               Powerup_Glock_Reload = 119,
        [SoundData("powerup/sword_sweep")]                      Powerup_Sword_Sweep = 97,
        [SoundData("powerup/bat/bat_swing")]                    Powerup_Bat_Swing = 98,
        [SoundData("powerup/bat/bat_hit")]                      Powerup_Bat_Hit = 99,
        [SoundData("powerup/portalgun/portal_enter")]           Powerup_Portal_Enter = 111,
        [SoundData("powerup/portalgun/portal_exit")]            Powerup_Portal_Exit = 112,
        [SoundData("powerup/portalgun/portal_fizzle")]          Powerup_Portal_Fizzle = 113,
        [SoundData("powerup/portalgun/portal_invalid_surface")] Powerup_Portal_Invalid = 114,
        [SoundData("powerup/portalgun/portal_open")]            Powerup_Portal_Open = 115,
        [SoundData("powerup/portalgun/portalgun_shoot_blue")]   Powerup_Portal_ShootA = 116,
        [SoundData("powerup/portalgun/portalgun_shoot_red")]    Powerup_Portal_ShootB = 117,
        [SoundData("powerup/bat/bat_ball")]                     Powerup_Bat_Ball = 118,

        //Boss Fights!
        [SoundData("boss/saxton/brave_jump/brave")]             Boss_Saxton_BraveJump = 121,
        [SoundData("boss/saxton/idle/idle")]                    Boss_Saxton_Idle = 122,
        [SoundData("boss/saxton/hithurt/hitsound")]             Boss_Saxton_Hit = 123,
        [SoundData("boss/saxton/hithurt/killsound")]            Boss_Saxton_Kill = 124,
        ...
        //PotatOS
        [SoundData("GladOS/death")]                             Glados_Taunt_Die = 100,
        [SoundData("GladOS/glados_almost_die")]                 Glados_Taunt_AlmostDie = 101,
        [SoundData("GladOS/glados_bored")]                      Glados_Taunt_Bored = 102,
        [SoundData("GladOS/glados_grab")]                       Glados_Grab = 103,
        [SoundData("GladOS/glados_taunt_bump")]                 Glados_Bump = 104,
        [SoundData("GladOS/glados_taunt_die_portal")]           Glados_Taunt_Die_Portal = 105,
        [SoundData("GladOS/glados_taunt_jump")]                 Glados_Taunt_Jump = 106,
        [SoundData("GladOS/glados_taunt_lose")]                 Glados_Taunt_Lose = 107,
        [SoundData("GladOS/glados_taunt_win")]                  Glados_Taunt_Win = 108,
        [SoundData("GladOS/glados_taunt_tbag")]                 Glados_Taunt_TBag = 109,
        [SoundData("GladOS/glados_taunt_rolljump")]             Glados_Taunt_Rolljump = 110,
    }
...
public static class SoundDataExtensions {
    ...
    public static bool IsVoc(this Enums.Sounds sound, PlayerData player = null, int variant = 0) {
        SoundData data = GetSoundDataFromSound(sound);
        string name = "Sound/" + data.Sound + (variant > 0 ? "_" + variant : "");
