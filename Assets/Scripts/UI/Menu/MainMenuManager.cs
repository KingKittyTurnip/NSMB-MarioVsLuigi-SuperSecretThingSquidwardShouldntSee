...
public class MainMenuManager : MonoBehaviour, ILobbyCallbacks, IInRoomCallbacks, IOnEventCallback, IConnectionCallbacks, IMatchmakingCallbacks {
    ...
    public void Start() {
        ...
        {
            characterDropdown.options = new List<TMP_Dropdown.OptionData>
            {
                characterDropdown.options[0],
                characterDropdown.options[1],
                characterDropdown.options[2],
                characterDropdown.options[3],
            };
        }
        SingletonModeTag.mode = SingletonModeTag.Mode.None;
        /*
    ...
    {
        PhotonNetwork.Disconnect();
        SceneManager.LoadScene("SinglePlayer CharSelect");
    }
}
