...
namespace NSMB.Utils {
    public static class NetworkUtils {
        ...
        private readonly static Hashtable _defaultSoloRoomProperties = new() {
            [Enums.NetRoomProperties.Level] = 0,
            [Enums.NetRoomProperties.StarRequirement] = 1,
            [Enums.NetRoomProperties.CoinRequirement] = 8,
            [Enums.NetRoomProperties.Lives] = 3,
            [Enums.NetRoomProperties.Time] = -1,
            [Enums.NetRoomProperties.DrawTime] = true,
            [Enums.NetRoomProperties.NewPowerups] = true,
            [Enums.NetRoomProperties.GameStarted] = false,
            [Enums.NetRoomProperties.HostName] = "",
            [Enums.NetRoomProperties.Debug] = false,
        ...
        public static Hashtable SoloDefaultRoomProperties {
            get {
                Hashtable ret = new();
                ret.Merge(_defaultSoloRoomProperties);
                return ret;
            }
            private set { }
        }
